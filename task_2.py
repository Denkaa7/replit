...
bal1 = int(input('Введите кол-во баллов по русскому языку: '))
bal2 = int(input('Введите кол-во баллов по математике: '))
bal3 = int(input('Введите кол-во баллов по информатике: '))
if bal1 + bal2 + bal3 >= 270:
